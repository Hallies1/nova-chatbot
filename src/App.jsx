...
fontWeight: 700,
letterSpacing: "-1px",
background: "linear-gradient(90deg, #f0ece4 60%, #a78bfa)",
...
<p style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#6b7280", marginBottom: 8 }}>
Common questions
</p>
...
background: loading || !input.trim() ? "rgba(167,139,250,0.2)" : "linear-gradient(135deg, #7c3aed, #a78bfa)",
border: "none", cursor: loading || !input.trim() ? "default" : "pointer",
fontSize: 20, color: "#fff", flexShrink: 0, transition: "all 0.2s",
}}
>↑</button>
</div>
</div>
...
content: "First-generation college students face a distinct disadvantage: they lack the informal knowledge networks that legacy students have. They don't know what questions to ask, who to ask, or whether their question is \"dumb.\" This leads to underutilization of financial aid, delayed course corrections, and higher dropout rates. Advisors are stretched thin — average student-to-advisor ratio at public universities is 441:1."
},
{
emoji: "👥",
title: "Target Users",
content: "Primary: First-gen undergrads (18–22) at mid-size public universities. Secondary: Transfer students re-navigating a new system. They share a common trait: high anxiety around not knowing what they don't know. They are comfortable with conversational interfaces (messaging-native generation) and more likely to ask a chatbot a \"basic\" question than risk embarrassment with a human."
},
{
emoji: "🔍",
title: "How Do We Know This Is the Right Problem?",
content: "Hypothetical research methods used: (1) Interviews with 8 first-gen students at a state university — 7 of 8 mentioned feeling too embarrassed to ask advisors repeat questions. (2) Survey of 40 students: 68% had a college question they \"Googled instead of asking someone.\" (3) Review of NCAN (National College Access Network) research showing first-gen students are 2x less likely to use campus advising services. This points to a trust and access gap, not a resource gap."
},
{
emoji: "💬",
title: "How Users Interact",
content: "The chatbot is embedded on the university student portal, accessible 24/7. Students interact conversationally — no forms, no appointments. Key interaction patterns: open-ended questions (\"I don't know where to start\"), scenario-based queries (\"I'm thinking of switching majors\"), and stress venting (\"I'm really overwhelmed\"). Nova acknowledges emotional context before giving information, mimicking what a great advisor does."
},
{
emoji: "📊",
title: "How We Measure Effectiveness",
content: "Success metrics: (1) Task completion rate — did the student get an actionable answer? Measured via end-of-session rating. (2) Advisor follow-through — did the student book a real appointment after Nova suggested it? (3) Retention signal — students who used Nova at least twice in semester 1 vs. dropout rate. (4) Qualitative: session transcripts coded for confusion → clarity arc. North star metric: % of students who report \"feeling more confident navigating college\" at semester-end survey."
},
{
emoji: "⚠️",
title: "Risks & Limitations",
content: "Nova is not a replacement for human advisors — it is explicitly designed to route students TO them at the right moment. Key risks: (1) Over-reliance reducing human contact. (2) Hallucinated financial aid info causing real harm — mitigated by grounding Nova in verified university FAQs. (3) Equity of access — students without reliable devices need offline alternatives. These were considered in the design and would be revisited with real data."
},
...
<h3 style={{ margin: 0, fontSize: 16, letterSpacing: 0.3, color: "#c4b5fd" }}>{title}</h3>
</div>
...
<p style={{ color: "#9ca3af", fontSize: 14, fontStyle: "italic", marginBottom: 20 }}>
These are hypothetical personas constructed from aggregated research patterns, not real individuals. Each represents a distinct user archetype identified during discovery.
</p>
...
color: p.color, background: `${p.color}18`, padding: "2px 8px", borderRadius: 10,
}}>{p.tag}</span>
</div>
<p style={{ margin: "0 0 14px", fontSize: 14, fontStyle: "italic", color: "#9ca3af", lineHeight: 1.5 }}>
"{p.quote}"
</p>
<button
